...
const array2 = [ "elem4", "elem5", "elem6" ];
...
console.log( optional( array1, array2, [ "elem7", "elem8", "elem9" ] ) );
...
const original = { prop1: "value1", prop2: 2 };
...
console.log("Have you read and have you got Devastación?");
console.log(isBookRead(books, "Devastación")); // true
console.log("Have you read and have you got Canción de hielo y fuego?");
...
class SlothMachine {
  ...
  wheels(numOfWheels){
    let arr = [];
    for(let i = 0; i<numOfWheels; i++){
        arr.push(Boolean(Math.floor(Math.random()*2)));
    }
    return arr;
  }
